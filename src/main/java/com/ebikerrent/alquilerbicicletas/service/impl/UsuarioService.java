...
import com.ebikerrent.alquilerbicicletas.dto.entrada.modificacion.UsuarioModificacionEntradaDto;
...
public class UsuarioService implements IUsuarioService {
    ...
    public List<UsuarioSalidaDto> listar() {
        List<UsuarioSalidaDto> usuarios = usuarioRepository.findAll().stream().map(this::entidadADto).toList();//manejaría con excepciones por si no hay usuarios
    ...
    @Override
    public UsuarioSalidaDto modificarUsuario(UsuarioModificacionEntradaDto usuarioModificacionEntrada) throws ResourceNotFoundException {
